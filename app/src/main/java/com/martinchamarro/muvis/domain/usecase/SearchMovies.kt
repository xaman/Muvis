...
class SearchMovies @Inject constructor(
    ...
    fun execute(text: String, onSuccess: (List<Movie>) -> Unit, onError: (Throwable) -> Unit) {
        this.text = text
        execute(onSuccess, onError)
    }

    override fun onExecute(): Either<Throwable, List<Movie>> = repository.searchMovies(text)
}